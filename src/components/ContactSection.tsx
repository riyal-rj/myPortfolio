...
import { Mail, Calendar, MessageCircle, Heart, Repeat2, MapPin, Clock } from "lucide-react";
    ...
    <div className="space-y-0">
      ...
      <div className="border-b border-border p-4 sm:p-6 hover:bg-accent/50 transition-colors">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center flex-wrap gap-x-2 gap-y-1 mb-2 sm:mb-3">
              <span className="font-semibold text-sm sm:text-base">Ritankar Jana</span>
              <span className="text-muted-foreground text-xs sm:text-sm">@jana_ritankar</span>
              <span className="text-muted-foreground text-xs sm:text-sm">·</span>
              <span className="text-muted-foreground text-xs sm:text-sm">2h</span>
            </div>

            <div className="space-y-3">
              <h3 className="font-bold text-base sm:text-lg">Current Availability 📅</h3>

              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full animate-pulse"></div>
                  <div>
                    <p className="font-medium text-green-700 dark:text-green-300 text-xs sm:text-sm">Available for new projects</p>
                    <p className="text-xs sm:text-sm text-green-600 dark:text-green-400">Response time: Usually within 24 hours</p>
                  </div>
                </div>
                ...
                <Card>
                  <CardContent className="p-3 sm:p-4">
                    <h4 className="font-medium text-sm sm:text-base mb-1 sm:mb-2">What I'm looking for:</h4>
